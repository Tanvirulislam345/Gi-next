...
import { Button, CardContainer, HeaderName, HrRule } from '../style/ComponentStyles';
    ...
    return (
        <Container>
            ...
            <Row xd={1} sm={2} md={3} lg={4} className="g-3 mt-3">
                {
                    [1, 2, 3, 4, 5, 6, 7, 8, 9].map((data, index) => <Col><Card
                    ...
                    >
                        ...
                        <div style={{ padding: "20px" }}>
                            ...
                            <HeaderName FontSize="12px" FontWeight="400" Color="black">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Diam nec potenti commodo, nunc tincidunt. Nisi quisque nibh volutpat nunc, platea.</HeaderName>
                            <Button
...
function Nav() {
    ...
    return (<>
        <CardContainer JustifyContent="start" Margin="50px 0px 10px">
            {
                values.map((data, index) => <HeaderName
                    FontSize="18px"
                    FontWeight="500"
                    Padding="0px 10px"
