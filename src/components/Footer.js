...
import { Button, CardContainer, DivContainer, HeaderName, Input } from '../style/ComponentStyles';
    ...
    return (
        <DivContainer BgImage={`url(${footerImage})`} MinHeight="90vh">
            <Container>
                ...
                <HeaderName FontSize="14px" FontWeight="400" TextAlign="center" Color="#ffffff">© 2022 Ginexttradingcorp.</HeaderName>
            </Container>
        </DivContainer >
    );
};
    ...
    return (
        <>
            ...
            <CardContainer Gap="20px">
                ...
                <Button FontSize="10px" Padding="10px 25px">Get Started</Button>
            </CardContainer>
        </>
    )
}